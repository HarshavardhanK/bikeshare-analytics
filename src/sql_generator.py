...
class SQLGenerator:
    ...
    def generate(self, intent, mappings):
        ...
        # Debug logging for SQL and values
        try:
            logging.debug("[SQLGenerator] SQL: %s", sql)
            logging.debug("[SQLGenerator] Values: %s", values)
        except Exception as e:
            logging.error("[SQLGenerator] Error logging SQL or values: %s", e)
